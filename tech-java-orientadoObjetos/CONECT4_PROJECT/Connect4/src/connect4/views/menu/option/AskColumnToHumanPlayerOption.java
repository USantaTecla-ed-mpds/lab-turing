...
public class AskColumnToHumanPlayerOption extends TurnOption {

    public AskColumnToHumanPlayerOption(String title, Turn turn) throws MessageNotFoundException {
        super(title, turn);
    }
